...
<div class="sidebar">
    ...
    <ul class="nav flex-column mt-5">
        ...
        <li class="nav-item"><a href="#" class="nav-link"><i class="bi bi-cash-stack"></i> Manajemen Gaji</a></li>
        <li class="nav-item"><a href="#" class="nav-link"><i class="bi bi-calendar2-check"></i> Manajemen Cuti</a></li>
        <li class="nav-item"><a href="#" class="nav-link active"><i class="bi bi-gift"></i> Reward & Recognition</a></li>
