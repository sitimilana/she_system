...
<head>
    ...
    <style>
        ...
        /* DITAMBAHKAN: transisi margin kiri untuk efek menu hp */
        .content { 
            margin-left: 250px; 
            padding: 40px; 
            min-height: 100vh;
        ...
        @media (max-width: 768px) {
            ...
            /* Agar input search di mobile terlihat lebih rapi */
            .search-bar { max-width: 100%; width: 100%; margin-bottom: 10px; }
            #formFilter { flex-direction: column; align-items: stretch; }
            #jenisCutiSelect { width: 100% !important; margin-bottom: 10px; }
            
            /* Agar tombol bagikan jatah cuti di mobile responsif */
            .btn-jatah-cuti { width: 100%; display: block; text-align: center; }
        }
        /* --------------------------------------- */
    </style>
</head>
...
<div class="content">
    <div class="d-flex justify-content-between align-items-center mb-4 d-md-none bg-white p-3 rounded-3 shadow-sm border">
        <h5 class="fw-bold m-0" style="color: #2c3e50;">Manajemen Cuti</h5>
        <button class="btn btn-light border" id="openSidebarBtn">
            <i class="bi bi-list fs-4"></i>
        </button>
    </div>

    <div class="d-md-flex justify-content-between align-items-center mb-4 d-none d-md-block">
        <div>
    ...
    <div class="card card-custom p-4">
        ...
        <div class="d-flex justify-content-center mt-3">
            {{ $dataCuti->appends([
                'riwayat_page' => request('riwayat_page'),
