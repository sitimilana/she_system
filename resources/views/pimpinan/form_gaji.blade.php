            ...
            <div class="row mt-4">
                <div class="col-md-6 pe-md-4 border-end">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">Rp</span>
                            <input type="number" class="form-control calc-penerimaan" name="leader" value="0">
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">Rp</span>
                            <input type="number" class="form-control calc-penerimaan" name="kinerja" value="0">
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">Rp</span>
                            <input type="number" class="form-control calc-penerimaan" name="program" value="0">
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">Rp</span>
                            <input type="number" class="form-control calc-penerimaan" name="bpjs" value="0">
                        </div>
                    </div>
                    <div class="mb-3">
